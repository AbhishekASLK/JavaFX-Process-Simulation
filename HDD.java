...
public class HDD {
    ...
    static Scene HDDScene;
    static void openHDDScene(Stage primaryStage,Scene mainScene) {
        ...
        nextButton.setOnAction(e->HDDToRAM.openHDDToRAMScene(primaryStage,mainScene));
        ...
        nextButton2.setOnAction(e->ProcessExecution.openProcessExecutionScene(primaryStage,mainScene));
        ...
        Scene HDDScene = new Scene(root,1092, 614);
        primaryStage.setScene(HDDScene);
        primaryStage.show();
